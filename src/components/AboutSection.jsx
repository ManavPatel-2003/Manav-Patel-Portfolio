import { Briefcase, Code, User, GraduationCap, School, ExternalLink } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
              ...
              <a
                href="https://drive.google.com/file/d/1M3b_NgxRF5rtXw3EEuCL8grBPiPZhL9h/view?usp=sharing"
